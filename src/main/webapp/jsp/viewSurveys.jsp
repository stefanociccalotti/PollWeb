                                    ...
                                    <ul class="edit-nav">
                                        <li class="nav-item dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                                ...
                                                <form action="viewSurveys" method="POST"><input type="hidden" name="action" value="viewresult" /><input type="hidden" id="surveyidDW" name="surveyid" value="${item.id}" /><a class="dropdown-item" href="javascript:void(0)" onclick="this.parentNode.submit();"><i class="ti-search m-r-5 m-l-5"></i> Vedi Risultato</a></form>
                                                <c:if test="${item.status.equals('salvato')}"><form action="viewSurveys" method="POST"><input type="hidden" name="surveyid" value="${item.id}" /><input type="hidden" name="action" value="publish" /><a class="dropdown-item" href="javascript:void(0)" onclick="this.parentNode.submit()"><i class="ti-agenda m-r-5 m-l-5"></i> Pubblica Sondaggio</a></form></c:if>
