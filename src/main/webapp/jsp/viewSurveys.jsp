                                    ...
                                    <ul class="edit-nav">
                                        <li class="nav-item dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                                ...
                                                <c:if test="${!item.status.equals('pubblicato')}"><form action="viewSurveys" method="POST"><input type="hidden" name="surveyid" value="${item.id}" /><input type="hidden" name="action" value="publish" /><a class="dropdown-item" href="javascript:void(0)" onclick="this.parentNode.submit()"><i class="ti-search m-r-5 m-l-5"></i> Pubblica</a></form></c:if>
